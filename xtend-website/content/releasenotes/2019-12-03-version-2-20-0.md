...
![Refactoring: Import Static Method](/Xtext/xtend/images/releasenotes/2_20_refactoring_import_static_method.gif){:height="50%" width="50%"}
...
![Quick Fix: Add JUnit 4 to Classpath](/Xtext/xtend/images/releasenotes/2_20_quickfix_add_junit4_classpath.gif){:height="50%" width="50%"}
![Quick Fix: Add JUnit 5 to Classpath](/Xtext/xtend/images/releasenotes/2_20_quickfix_add_junit5_classpath.gif){:height="50%" width="50%"}
