...
![](/Xtext/xtend/images/releasenotes/2_8_xbase-java-version.png)
...
![](/Xtext/xtend/images/releasenotes/2_8_xbase-open-generated.png)

### Open Inferred Type

You can open the declaration of the inferred type of a local variable by *Ctrl*-clicking (*Cmd* on Mac) the variable name. 

![](/Xtext/xtend/images/releasenotes/2_8_open-inferred-type.png)
...
![](/Xtext/xtend/images/releasenotes/2_8_java-convert-to-xtend.png)
