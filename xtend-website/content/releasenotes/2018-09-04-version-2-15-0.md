...
![](/Xtext/xtend/images/releasenotes/2_15_xtext_core.png){:height="50%" width="50%"}

2.15:

![](/Xtext/xtend/images/releasenotes/2_15_xtext_core_fast.png){:height="50%" width="50%"}
...
![](/Xtext/xtend/images/releasenotes/2_15_junit_quickfix.png){:height="50%" width="50%"}
