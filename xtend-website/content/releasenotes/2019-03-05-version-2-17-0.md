...
![Quickfix for 'unused private member'](/Xtext/xtend/images/releasenotes/2_17_Xtend-quickfix-remove-unused-member.gif){:height="50%" width="50%"}
...
![Quickfix to add the abstract modifier](/Xtext/xtend/images/releasenotes/2_17_Xtend-quickfix-add-abstract-modifier-bc-classname.gif){:height="50%" width="50%"}
...
![Use favorites for static import](/Xtext/xtend/images/releasenotes/2_17_Xtend-static-favorites_1.gif){:height="50%" width="50%"}
...
![Invoke content assist static import](/Xtext/xtend/images/releasenotes/2_17_Xtend-static-favorites_2.png){:height="50%" width="50%"}
...
![Invoke content assist static import](/Xtext/xtend/images/releasenotes/2_17_Xtend-static-favorites_3.png){:height="50%" width="50%"}
